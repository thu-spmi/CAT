...
if [ $stage -le 4 ]; then
  ...
  mkdir -p data/pickle
  python3 ctc-crf/convert_to.py $ark_dir/cv.scp $data_cv/text_number $data_cv/weight data/hdf5/cv.pickle
  python3 ctc-crf/convert_to.py $ark_dir/tr.scp $data_tr/text_number $data_tr/weight data/hdf5/tr.pickle
fi
