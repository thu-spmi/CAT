...
if __name__ == "__main__":
    ...
    parser.add_argument("lang", type=str, help="Language ID.")
    parser.add_argument(
        "data_dir",
        type=str,
        help=(
            "The path to the feats.scp and text, "
        ),
    )
    parser.add_argument("out_dir", type=str, help="The output path")
    args = parser.parse_args()
    f_scps = f'{args.data_dir}/{args.lang}/excluded_train/feats.scp'
    f_labels=f'{args.data_dir}/{args.lang}/excluded_train/text'
    d_out = f'{args.out_dir}/{args.lang}'
    fmt=f'{args.lang}_%05d.tar'
