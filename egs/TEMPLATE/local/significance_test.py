...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "result_path1", type=str, help="The result file path (.json) of exp1"
    )
    parser.add_argument(
        "result_path2", type=str, help="The result file path (.json) of exp2"
    )
    parser.add_argument(
        "--method",
        type=str,
        default="mp",
        help="Matched pair test (mp) or McNemar test (mc)",
    )
