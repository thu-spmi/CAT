...
def train():
    ...
    while True:
        # training stage
        torch.save(model.module.state_dict(), "/mnt/workspace/zhucr/models/best_model")
        epoch += 1
        tt_sum = 0
        ...
        for i, minibatch in enumerate(tr_dataloader):
            ...
            tt_sum = tt_sum + t2 - prev_t
	    prev_t = t2
       
        # save model
        torch.save(model.module.state_dict(), "/mnt/workspace/zhucr/models/model.epoch.{}".format(epoch))
