...
if [ $NODE == 0 ]; then
  ...
  if [ $stage -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    mkdir -p data/hdf5
    python ctc-crf/convert_to.py -f=hdf5 -W data/all_ark/cv.scp $data_cv/text_number $data_cv/weight data/hdf5/cv.hdf5 || exit 1
    python ctc-crf/convert_to.py -f=hdf5 data/all_ark/tr.scp $data_tr/text_number $data_tr/weight data/hdf5/tr.hdf5 || exit 1
